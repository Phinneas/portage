...
export const FIELD_MAP: Record<string, { astro: string; transform?: (v: unknown) => unknown }> = {
  ...
  lastModifiedAt:   { astro: 'updatedDate', transform: (v) => coerceDate(v) },
  ...
  image:            { astro: 'heroImage' },
  imageAlt:         { astro: 'heroImageAlt' },
  heroImageAlt:     { astro: 'heroImageAlt' },
  draft:            { astro: 'draft',      transform: (v) => coerceBoolean(v) },
  featured:         { astro: 'featured',   transform: (v) => coerceBoolean(v) },
  ...
  'frontmatter.featured':        { astro: 'featured',   transform: (v) => coerceBoolean(v) },
  'frontmatter.canonical_url':   { astro: 'canonicalURL' },
  'frontmatter.canonicalUrl':    { astro: 'canonicalURL' },
  ...
  'frontmatter.seo.image':       { astro: 'seo.image' },
};
